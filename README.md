...
В одноканальной СМО с очередью при плотностях входного и выходного потоков &lambda; = 1, &mu; = 1/0,99 = 1.01 время ожидания стабилизируется на уровне 70, но установившийся режим наступает примерно через 50000 единиц времени: 
```MATLAB
