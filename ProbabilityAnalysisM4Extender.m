classdef ProbabilityAnalysisM4Extender < handle
    ...
    methods
        function obj = ProbabilityAnalysisM4Extender(root)
            % Init
            if nargin < 1
    ...
    methods (Hidden)
        ...
        function [nname, npath] = cloneclass(obj, classname, sourcedir, prename)
            ...
            obj.txtrep(npath, "obj.ext = ProbabilityAnalysisM4Extender", "obj.ext = " + obj.getvalidname + "Extender");
            obj.txtrep(npath, "upd = ProbabilityAnalysisM4Updater", "upd = " + obj.getvalidname + "Updater");
        end
